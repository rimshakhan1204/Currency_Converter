...
public class CurrencyConverter extends JFrame implements ActionListener {
    ...
    public CurrencyConverter() {
        ...
        add(amountField);
        amountField.setBackground(new Color(176, 196, 222));
        amountField.setFont(new Font(" Enter Amount", Font.BOLD, 14));
        amountField .setBounds(170, 53, 250, 26);
        ...
        add(resultField);
        resultField.setBackground(new Color(176, 196, 222));
        resultField.setFont(new Font(" Enter Amount", Font.BOLD, 14));
